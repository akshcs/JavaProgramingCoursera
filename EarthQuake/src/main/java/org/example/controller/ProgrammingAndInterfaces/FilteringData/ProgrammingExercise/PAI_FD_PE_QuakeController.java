package org.example.controller.ProgrammingAndInterfaces.FilteringData.ProgrammingExercise;
...
@RestController
@RequestMapping("/PAI/FD/PE/")
public class PAI_FD_PE_QuakeController {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Programming and Interfaces Filtering Data Programming Exercise Answers";
    }
    ...
    @GetMapping("largest")
    ArrayList<QuakeEntry> getLargest(){
        return earthQuakeService.getNLargest(1);
    }

    @GetMapping("NLargest/{howMany}")
    ArrayList<QuakeEntry> getNLargest( @PathVariable("howMany") int howMany){
