package org.example.controller.ProgrammingAndInterfaces.review;
...
@RestController
@RequestMapping("/PAI/Review/")
public class PAI_Review_QuakeController {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Programming and Interfaces Review Answers";
    }
