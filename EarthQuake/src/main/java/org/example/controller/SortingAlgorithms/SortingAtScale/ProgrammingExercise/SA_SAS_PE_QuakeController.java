package org.example.controller.SortingAlgorithms.SortingAtScale.ProgrammingExercise;
...
@RestController
@RequestMapping("/SA/SAS/PE/")
public class SA_SAS_PE_QuakeController {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting Algorithms Sorting At Scale Programming Exercise Answers";
    }
