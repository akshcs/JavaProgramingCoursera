...
@RestController
@RequestMapping("/SA/ISS/PE/Sample2/")
public class SA_ISS_PE_QuakeControllerSample2 {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting and Algorithms Implementing Selection Sort Programming Exercise Sample 2 Answers";
    }
