...
@RestController
@RequestMapping("/SA/Review/Sample2/")
public class SA_Review_QuakeControllerSample2 {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting and Algorithms Review Sample 2 Answers";
    }
