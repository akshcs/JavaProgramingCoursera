...
@RestController
@RequestMapping("/SA/SAS/PQ/Sample2/")
public class SA_SAS_PQ_QuakeControllerSample2 {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting and Algorithms Sorting at Scale Practice Quiz Sample 2 Answers";
    }
