package org.example.controller.SortingAlgorithms.SortingAtScale.PracticeQuiz;
...
@RestController
@RequestMapping("/SA/SAS/PQ/Sample1/")
public class SA_SAS_PQ_QuakeControllerSample1 {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting and Algorithms Sorting at Scale Practice Quiz Sample 1 Answers";
    }
