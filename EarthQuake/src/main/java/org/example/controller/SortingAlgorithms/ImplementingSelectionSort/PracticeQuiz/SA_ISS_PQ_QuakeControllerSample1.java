...
@RestController
@RequestMapping("/SA/ISS/PQ/Sample1/")
public class SA_ISS_PQ_QuakeControllerSample1 {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting and Algorithms Implementing Selection Sort Practice Quiz Sample 1 Answers";
    }
