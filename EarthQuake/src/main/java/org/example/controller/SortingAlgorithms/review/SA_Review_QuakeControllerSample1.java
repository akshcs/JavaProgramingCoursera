package org.example.controller.SortingAlgorithms.review;
...
@RestController
@RequestMapping("/SA/Review/Sample1/")
public class SA_Review_QuakeControllerSample1 {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting and Algorithms Review Sample 1 Answers";
    }
