package org.example.controller.SortingAlgorithms.ImplementingSelectionSort.ProgrammingExercise;
...
@RestController
@RequestMapping("/SA/ISS/PE/Sample1/")
public class SA_ISS_PE_QuakeControllerSample1 {
    ...
    @GetMapping("")
    String home() {
        return "Hello Folks Welcome to Sorting and Algorithms Implementing Selection Sort Programming Exercise Sample 1 Answers";
    }
